...
/** Copy for /whatsapp-alternative. `**bold**` is rendered by <RichText />. */
export type WhatsappAlternativeCopy = {
  meta: { title: string; description: string };
  hero: {
    imageAlt: string;
    headline: { before: string; move: string; between: string; whatsapp: string };
    sub: string;
    cta: string;
    chips: string[];
  };
  ...
  chat: { eyebrow: string; heading: string; body: string; link: string };
...
export const whatsappAlternativeCopy: Copy<WhatsappAlternativeCopy> = {
  id: {
    meta: {
      title: 'Binder — Alternatif WhatsApp buat grup kamu',
      description:
        'Capek grup WhatsApp berantakan, akun ke-banned, dan chat ilang tiap ganti HP? Pindah ke Binder: chat, file, dan catatan grup jadi satu tempat, nomor kamu tetap privat.',
    },
    hero: {
      imageAlt: 'Rumah kayu di lembah pegunungan saat senja',
      headline: { before: 'Saatnya grup kamu ', move: 'pindah', between: ' dari ', whatsapp: 'WhatsApp' },
      sub: 'Chat, file, dan catatan grup jadi satu tempat. Nomor kamu tetap privat, chat nggak ilang waktu ganti HP, dan nggak ada drama akun ke-banned.',
      cta: 'Pindah ke Binder (gratis)',
      chips: ['Ga tiba-tiba ke banned', 'Chat nggak ilang pas ganti HP', 'Ada tempat buat file & catatan'],
    },
    compare: {
      eyebrow: 'WHATSAPP VS BINDER',
      heading: 'Yang bikin capek di WhatsApp, nggak ada di Binder',
      sub: 'Bukan soal ganti aplikasi chat. Ini soal grup kamu akhirnya punya tempat yang beres.',
    ...
    chat: {
      ...
      body: 'Tiap topik punya **thread** sendiri. Pengumuman penting nggak ketimbun stiker, dan yang baru gabung bisa langsung ngerti isinya tanpa scroll dari awal. Dan kalau mau dibantu **AI agent**, tinggal undang ke grup — nggak perlu takut kena banned.',
      link: 'Coba sendiri →',
    },
    library: {
      eyebrow: 'LIBRARY GRUP',
      heading: 'Akhirnya ada tempat naruh file dan catatan',
      body: 'Tiap grup punya **Catatan**, **Materi**, **Folder**, dan **To-do** sendiri. Dokumen penting tersimpan rapi dan nggak expired — jadi nggak ada lagi "tolong kirim ulang filenya dong".',
    ...
    founder: {
      ...
      paragraphs: [
        ...
        'Pernah ga sih, lu jadi admin group, terus tiap ada member baru, lu harus copas peraturan/introduction lagi, karena chat sebelumnya ga bisa dibaca??',
        'Atau, semua chat lu hilang gara-gara pindah hp dari Android ke iOS?',
        'Ya Allah, painful banget. Belum lagi, gw ada di puluhan grup WhatsApp, dan makin hari makin rame. Banyak chat penting yang jadi ketimbun.',
        'Tiap masuk grup baru, nomor gw langsung kelihatan semua orang. Nggak lama, telepon dari nomor asing dan tawaran-tawaran aneh mulai berdatangan.',
        'Gw dan tim ingin solve itu semua, makanya kami bikin Binder.',
        'Di Binder, chat, catatan, bahkan course ada di satu tempat. Kamu dikenal lewat username, bukan nomor HP. Dan waktu kamu ganti HP, semuanya masih ada.',
    ...
    cta: {
      ...
      sub: 'Gratis, langsung dari browser — tanpa kartu kredit, tanpa install.',
    ...
    footer: {
      ...
      tagline: '© {year} heybinder.com · Tempat ngumpul grup kamu, tanpa drama.',
    },
  },

  en: {
    meta: {
      title: 'Binder — The WhatsApp alternative for your group',
      description:
        'Tired of messy WhatsApp groups, sudden bans, and losing every chat when you switch phones? Move to Binder: chat, files, and group notes in one place, with your number kept private.',
    },
    hero: {
      imageAlt: 'Cabin in a mountain valley at dusk',
      headline: { before: "It's time your group ", move: 'left', between: ' ', whatsapp: 'WhatsApp' },
      sub: 'Chat, files, and group notes in one place. Your number stays private, your chats survive a new phone, and there is no ban drama.',
      cta: 'Move to Binder (free)',
    ...
    founder: {
      ...
      paragraphs: [
        ...
        'In Binder, your chats, your notes, even courses live in one place. People know you by your username, not your phone number. And when you switch phones, everything is still there.',
    ...
    footer: {
      ...
      tagline: '© {year} heybinder.com · Where your group hangs out, minus the drama.',
    },
  },
};
